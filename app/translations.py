AR = {
    ...
    "credit": "الآجل",
    "credit_notes": "سندات الآجل",
    "add_credit_note": "إضافة سند آجل",
    ...
    "open": "مفتوح",
    "closed": "مدفوع",
    "no_credit_notes": "لا توجد سندات آجل",
    "add_payment": "إضافة دفعة",
    "payment": "دفعة",
    "payment_history": "سجل الدفعات",
    "credit_items": "المنتجات",
    "sell_on_credit": "بيع بالآجل",
    "credit_outstanding": "الديون المستحقة",
    "credit_note_created": "تم إنشاء سند الآجل بنجاح",
    "payment_added": "تمت إضافة الدفعة بنجاح",
    "customer_added": "تمت إضافة الزبون بنجاح",
    "no_customers": "لا يوجد زبائن",
    "select_product": "اختر منتجاً",
    "unit_price": "سعر الوحدة",
    "remove": "إزالة",
    "confirm_close_credit": "هل أنت متأكد من إغلاق هذا السند؟",
    "credit_note_closed": "تم إغلاق السند بنجاح",
}
...
FR = {
    ...
    "credit_items": "Articles",
    "sell_on_credit": "Vendre à crédit",
    "credit_outstanding": "Crédits impayés",
    "credit_note_created": "Note de crédit créée avec succès",
    ...
    "remove": "Retirer",
    "confirm_close_credit": "Êtes-vous sûr de vouloir fermer cette note ?",
    "credit_note_closed": "Note de crédit fermée avec succès",
}
...
EN = {
    ...
    "remove": "Remove",
    "confirm_close_credit": "Are you sure you want to close this credit note?",
    "credit_note_closed": "Credit note closed successfully",
}
